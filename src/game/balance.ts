...
export const ASTEROID_BASE_SPAWN_INTERVAL = 1.30;
export const ASTEROID_MIN_SPAWN_INTERVAL = 0.8;
export const ASTEROID_INITIAL_SPAWN_TIMER = 0.85;
export const EARLY_RAMP_GRACE_SECONDS = 3;
export const ASTEROID_SPAWN_RAMP = 0.009;
export const ASTEROID_VERTICAL_SPAWN_BAND_COUNT = 4;
...
export const ASTEROID_SPEED_RAMP = 1.8;
